...
if __name__ == '__main__':
    ...
    client: TikTokLiveClient = TikTokLiveClient(unique_id=streamer)
    ...
    async def on_like(event: LikeEvent):
        print("LIKE EVENT" + event.user.unique_id)
        write_to_file("LIKE:" + event.user.unique_id.encode('utf-8','ignore').decode("utf-8") + ":" + event.user.nickname.encode('utf-8','ignore').decode("utf-8"))
    ...
    async def on_join(event: JoinEvent):
        print("JOIN EVENT" + event.user.unique_id)
        write_to_file("JOIN:" + event.user.unique_id.encode('utf-8','ignore').decode("utf-8") + ":" + event.user.nickname.encode('utf-8','ignore').decode("utf-8"))
